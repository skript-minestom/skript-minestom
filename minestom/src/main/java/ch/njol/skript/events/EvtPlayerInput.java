...
public class EvtPlayerInput extends SkriptEvent {
	...
	public boolean check(Event event) {
		PlayerInputEvent inputEvent = ((PlayerInputWrapper) event).getEvent();
		Set<InputKey> previousKeys = InputKey.fromInput(inputEvent);
		Set<InputKey> currentKeys = InputKey.fromInput(inputEvent.getPlayer().inputs());
